...
export class LoginController {
  ...
  async redirect(@Query() query, @Session() session, @Res() res: Response) {
    ...
    return res.redirect(
      `app://app.scv.si/mobileapp?accessToken=${respons.accessToken}&refreshToken=${refreshToken}&expiresOn=${respons.expiresOn}`,
    ); //Tukaj samo vrnemo žeton za uporabnika na aplikaciji
  }
